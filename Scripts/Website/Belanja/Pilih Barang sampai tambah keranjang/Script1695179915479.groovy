...
WebUI.comment('Tambah Kain')

WebUI.click(findTestObject('Belanja/Keranjang/button_tambah_barang'))

WebUI.click(findTestObject('Belanja/Keranjang/tambah_kain'))

WebUI.click(findTestObject('Belanja/Shop/button_beli_tencel'))

WebUI.click(findTestObject('Belanja/Tencel/button_beli_30s'))

WebUI.click(findTestObject('Belanja/Tencel/button_celi_tencel_30s_marron'))
...
WebUI.setText(findTestObject('Belanja/Detail Kain/input_body'), '1.3')

WebUI.click(findTestObject('Belanja/Detail Kain/button_submit_beli'))

WebUI.click(findTestObject('Belanja/Keranjang/button_pengiriman'))

WebUI.click(findTestObject('Belanja/Keranjang/input_nomor_wa'))
