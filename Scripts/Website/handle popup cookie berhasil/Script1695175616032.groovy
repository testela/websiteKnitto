...
WebUI.verifyElementPresent(findTestObject('ModalDownloadE-Catalog/test_modal_ecatalog'), 10)
...
WebUI.verifyElementPresent(findTestObject('ModalCookies/test_modal_cookies'), 10)
